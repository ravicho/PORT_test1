...
set C_modelArgList {
	...
	{ addRandom uint 1 unused {axi_slave 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "in1","cData": "int512","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "in1","bundle": "control"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "in2","cData": "int512","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "in2","bundle": "control"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "out","cData": "int512","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "out_r","bundle": "control"},"direction": "WRITEONLY","cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_29ns_60_2_1_U1", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.urem_32ns_29ns_28_36_1_U2", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	vadd {
		gmem0 {Type I LastRead 346 FirstWrite -1}
		gmem1 {Type I LastRead 346 FirstWrite -1}
		gmem2 {Type O LastRead 349 FirstWrite 348}
		in1 {Type I LastRead 3 FirstWrite -1}
		in2 {Type I LastRead 3 FirstWrite -1}
		out_r {Type I LastRead 3 FirstWrite -1}
		size {Type I LastRead 0 FirstWrite -1}
		num_times {Type I LastRead 1 FirstWrite -1}
		addRandom {Type I LastRead -1 FirstWrite -1}}}
...
set busDeadlockParameterList { 
	{ gmem0 { NUM_READ_OUTSTANDING 64 NUM_WRITE_OUTSTANDING 16 MAX_READ_BURST_LENGTH 16 MAX_WRITE_BURST_LENGTH 16 } } \
	{ gmem1 { NUM_READ_OUTSTANDING 64 NUM_WRITE_OUTSTANDING 16 MAX_READ_BURST_LENGTH 16 MAX_WRITE_BURST_LENGTH 16 } } \
